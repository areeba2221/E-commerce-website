  ...
  return (
    ...
    >
      <div className="relative overflow-hidden aspect-4/3">
        ...
        <div
          className={`absolute inset-0 bg-[#3A3A3A] bg-opacity-70 flex flex-col items-center
      ...
      <div className="p-4 pb-6">
        <h3 className="font-bold text-[#3A3A3A] text-[24px] mb-1">
          {product.name}
        </h3>
        <p className="text-[#898989] text-[16px] mb-3 font-medium">
          {product.description}
        </p>
