...
import { productData, productsSectionData } from "/src/data/Data";
...
const RelatedProduct = () => {
    ...
    const repeatedProducts = [...productData]
    ...
    return (
      ...
      <div className="flex justify-center mt-12">
        <button className="border w-61.25 h-12 border-[#B88E2F] mb-25 text-[#B88E2F] font-semibold px-16 py-3 
