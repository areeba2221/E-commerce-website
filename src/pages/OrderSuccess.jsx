...
const OrderSuccess = () => {
    return (
        <>
            <Navbar />
            <div className="relative flex items-center justify-center w-screen h-[calc(100vh-70px)] antialiased font-sans overflow-hidden">
                ...
                <div className="w-full max-w-xl mx-4 absolute z-10 bg-[#F9F1E7]/95 backdrop-blur-sm 
        rounded-[32px] shadow-2xl overflow-hidden border border-slate-200/50">
                    <main className="flex flex-col items-center justify-center px-6 pt-12 pb-12 text-center">
                        <div className="flex items-center justify-center w-16 h-16 bg-[#52b788]
