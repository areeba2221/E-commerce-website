...
export const FilterRing = () => (
  <svg width="18" height="14" viewBox="0 0 18 14" fill="none">
    ...
    <circle cx="5" cy="2" r="2" fill="#f5ede3" stroke="currentColor" strokeWidth="1.5" />
    <circle cx="13" cy="7" r="2" fill="#f5ede3" stroke="currentColor" strokeWidth="1.5" />
    <circle cx="7" cy="12" r="2" fill="#f5ede3" stroke="currentColor" strokeWidth="1.5" />
  </svg>
);
...
export const Viewlist = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
    ...
    className="lucide lucide-align-vertical-space-around-icon lucide-align-vertical-space-around">
    <rect width="10" height="6" x="7" y="9" rx="2" />
    <path d="M22 20H2" /><path d="M22 4H2" /></svg>
);
...
export const BadgeCheck = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24"
    fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
    strokeLinejoin="round" className="lucide lucide-badge-check-icon lucide-badge-check">
    <path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z" />
    <path d="m9 12 2 2 4-4" /></svg>
);

export const Shipping = () => (
  <svg xmlns="http://w3.org" width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M16.5 9.4 7.55 4.24" />
    <path d="m21 16-9 5.23-9-5.23V7.97l9-5.23 9 5.23Z" />
    <path d="M12 22.3V12" />
    <path d="m12 12 8.5-4.9" />
    <path d="m12 12-8.5-4.9" />
  </svg>
);
...
//SinglProduct Page Sters
export const StarIcon = ({ filled }) => (
  <svg className={`w-5 h-5 ${filled ? "text-[#FFC700]" : "text-gray-300"}`} fill="currentColor" viewBox="0 0 20 20">
...
export const EyeOff = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" 
  stroke="gray" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-eye-off-icon lucide-eye-off"><path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143"/>
